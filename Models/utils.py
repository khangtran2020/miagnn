...
def draw_conf(graph:dgl.DGLGraph, model:torch.nn.Module, path:str, device:torch.device):
    ...
    nx.draw_networkx_nodes(G,pos,nodelist=id_postr, node_color=conf[id_postr], cmap=plt.cm.RdBu, node_shape='o')
    nx.draw_networkx_nodes(G,pos,nodelist=id_negtr, node_color=conf[id_negtr], cmap=plt.cm.RdBu, node_shape='s')
    nx.draw_networkx_nodes(G,pos,nodelist=id_poste, node_color=conf[id_poste], cmap=plt.cm.RdBu, node_shape='o')
    nx.draw_networkx_nodes(G,pos,nodelist=id_negte, node_color=conf[id_negte], cmap=plt.cm.RdBu, node_shape='s')
...
def draw_grad(graph:dgl.DGLGraph, model:torch.nn.Module, path:str, device:torch.device):
    ...
    nx.draw_networkx_nodes(G,pos,nodelist=id_postr, node_color=grad_norm[id_postr], cmap=plt.cm.RdBu, node_shape='o')
    nx.draw_networkx_nodes(G,pos,nodelist=id_negtr, node_color=grad_norm[id_negtr], cmap=plt.cm.RdBu, node_shape='s')
    nx.draw_networkx_nodes(G,pos,nodelist=id_poste, node_color=grad_norm[id_poste], cmap=plt.cm.RdBu, node_shape='o')
    nx.draw_networkx_nodes(G,pos,nodelist=id_negte, node_color=grad_norm[id_negte], cmap=plt.cm.RdBu, node_shape='s')
    nx.draw_networkx_edges(G,pos,arrows=True)
    # nx.draw_networkx_labels(G,pos)
