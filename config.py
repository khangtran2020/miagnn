...
def add_general_group(group):
    ...
    group.add_argument("--gen_mode", type=str, default='clean', help="Mode of running ['clean']", required=True)
    group.add_argument("--gen_submode", type=str, default='ind', help="Mode of GNN ['trans', 'ind'] / trans for transductive and ind for inductive", required=True)
...
def add_data_group(group):
    ...
    group.add_argument("--dens", type=float, default=1.0, help="density reduction rate")
...
def add_model_group(group):
    ...
    group.add_argument("--dout", type=float, default=0.2, help='dropout for the target model')
    group.add_argument("--pat", type=int, default=20, help='patience for early stopping')
    group.add_argument("--nhead", type=int, default=8, help='# head of attention for GAT')
    group.add_argument("--aggtype", type=str, default='mean')
    group.add_argument("--epochs", type=int, default=100, help='# training epochs for target model')
    group.add_argument("--retrain", type=int, default=0, help='retraining the target model or not')
...
def add_model_attack_group(group):
    ...
    group.add_argument('--att_hdim', type=int, default=64, help='hidden embedding dim for the attack model')
    group.add_argument("--att_lr", type=float, default=0.001, help="learning rate for the attack model training")
    group.add_argument('--att_bs', type=int, default=512, help="batch size for training process of the attack model")
    group.add_argument("--att_epochs", type=int, default=100, help='# training step for the attack model')
    group.add_argument("--sha_lr", type=float, default=0.001, help="learning rate of the shadow model")
    group.add_argument("--sha_epochs", type=int, default=100, help='training step for the shadow model')
    group.add_argument("--sha_rat", type=float, default=0.5, help="shadow graph ratio of the original graph")
    group.add_argument("--diff_rat", type=float, default=1.0, help="removal rate of pos/neg of attack model")
