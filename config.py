...
def add_general_group(group):
    group.add_argument("--project_name", type=str, default='', help="Name of the experiments", required=True)
    ...
    group.add_argument("--general_mode", type=str, default='clean', help="Mode of running ['clean', 'dp']", required=True)
    group.add_argument("--general_submode", type=str, default='ind', help="Mode of GNN ['trans', 'ind']", required=True)
